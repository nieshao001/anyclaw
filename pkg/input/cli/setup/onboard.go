...
func applyOnboardingDefaults(cfg *config.Config) {
	...
	cfg.Permissions.SandboxMode = firstNonEmpty(cfg.Permissions.SandboxMode, "workspace-write")
	cfg.Permissions.ApprovalPolicy = firstNonEmpty(cfg.Permissions.ApprovalPolicy, "on-request")
	cfg.Permissions.NetworkAccess = firstNonEmpty(cfg.Permissions.NetworkAccess, "enabled")
	cfg.Permissions.DesktopAccess = firstNonEmpty(cfg.Permissions.DesktopAccess, "ask-once-per-session")
